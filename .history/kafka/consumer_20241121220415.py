...
hospital_data_path = "hdfs://localhost:9092/hospital_data/in-hospital-mortality-trends-by-diagnosis-type.csv"
health_category_path = "hdfs://localhost:9092/hospital_data/in-hospital-mortality-trends-by-health-category.csv"
