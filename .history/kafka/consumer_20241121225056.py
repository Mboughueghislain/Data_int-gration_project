...
# Parser le CSV provenant du flux en utilisant from_csv avec le schéma
parsed_stream = streaming_data.selectExpr(f"from_csv(value, '{schema.simpleString()}') as data").select("data.*")
