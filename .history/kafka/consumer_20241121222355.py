...
join1 = parsed_stream.join(hospital_data, ["Date", "Category", "Setting"], "left_outer").withColumnRenamed("Count","Count1")

# Jointure entre le résultat précédent et 'health_category'
final_output = join1.join(health_category, ["Date", "Category", "Setting"], "left_outer").withColumnRenamed("Count","Count1")
